...
import { adjustForCoinSlippage, ClmmPoolUtil, Percentage, TickMath, } from "@cetusprotocol/cetus-sui-clmm-sdk";
...
const closePosition = {
    ...
    async handler(args) {
        ...
        const result = await runtime.signAndExecute(closePositionTransactionPayload);
        console.log(`close position transaction link: ${runtime.getTransactionLink(result.digest)}`);
    },
};
