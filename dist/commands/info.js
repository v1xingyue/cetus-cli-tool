        ...
        try {
            ...
            if (suiBalance.totalBalance.toString() == "0") {
                ...
                if (network == "devnet" || network == "testnet") {
                    console.log("You can get faucet from : https://faucet.testnet.sui.io/");
                }
                return;
            }
            ...
            for (const balance of balances) {
                ...
                tables.push({
                    ...
                    balance: new Decimal(balance.totalBalance).div(new Decimal(10).pow(new Decimal(meta?.decimals || 0))),
                    name: meta?.name,
                });
            }
